            ...
            <div className="bg-white rounded-b-[20px] px-[50px] py-[50px]">
              ...
              <div className="grid grid-cols-2 gap-[42px] mb-[40px]">
                ...
                <div>
                  ...
                  >
                    不用品・粗大ゴミの廃棄処分は別途料金がかかってお客様に負担をかけるうえ、処分工程でどうしても環境に悪影響が出てしまいます。そのため、エコ・グローバルでは廃棄処分量を減らし、回収品の適切な再利用に努めています。こうした廃棄処分を減らす試みで環境に配慮し、浮いた処分費を低価格の不用品・粗大ゴミ回収サービスとしてお客様に還元することで、信頼してお任せいただける回収業者を目指します。不用品・粗大ゴミの回収後は、品種ごとに仕分けるのはもちろん、廃品・家具・家電のように処分方法が定められている品種もお客様に代わり適切に対応します。
                  </p>
                </div>
              ...
              <div className="w-full">
                ...
                >
                  エコ・グローバルは不用品であっても安易な廃棄処分を行わず、千葉県を含む全国のリサイクルショップで再販、オークションや海外への輸出を通して収益化し、着物や家具は多少の破損であれば、リメイクを施して再活用するなど、品種に合わせた不用品の再利用を徹底しています。回収した粗大ゴミ・不用品の再利用を徹底する事は環境への配慮はもちろん、処分にかかる費用を削減する狙いもあります。作業料金から処分費を削減することで不用品回収にかかる料金の低価格化を実現、回収した不用品・廃品を適切に再利用して、次のお客様に還元するサイクルでエコ・グローバルは千葉県内を対象に、お客様と環境の両方に優しい不用品回収を実現しています。
                </p>
              </div>
            </div>
          </div>
