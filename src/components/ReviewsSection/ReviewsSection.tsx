  ...
  const testimonials: Testimonial[] = [
    {
      ...
      response:
        "遺品整理は、ただ物を片付けるだけではなく、故人の思い出や歴史を丁寧に扱う作業です。私たちエコグローバルのスタッフは、その重要性を常に心に留め、作業にあたらせていただいております。お客様のお父様の部屋が、思い出を大切にしながらも、新たなスペースとして生まれ変わったことを嬉しく思います。今後とも、お客様の大切な思い出に寄り添いながら、最高のサービスを提供できるよう努めてまいります。この度はエコグローバルをご利用いただき、誠にありがとうございました",
    ...
    },
    {
      ...
      response:
        "お客様のご満足の声をいただき、大変嬉しく思います。引越しの準備は予想外の事態が生じやすく、特に退去日が迫っているときは、時間との戦いになります。エコグローバルでは、そうした緊急の状況にも柔軟に対応し、迅速なサービスを心がけております。お客様の退去期限に間に合わせることができ、安心していただけたことをスタッフ一同、喜んでおります。",
      avatar: "/images/testimonials/avatar_female.png",
      position: "right",
    },
    {
