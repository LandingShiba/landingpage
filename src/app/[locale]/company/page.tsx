        ...
        <main className="bg-white mx-auto min-h-screen leading-[1.3]">
            ...
            <div className="container max-w-[1440px] mx-auto px-5 sm:px-6 lg:py-5 lg:px-0">
                ...
                <div className="lg:mx-auto lg:max-w-[1080px]">
                    ...
                    {/* Section About */}
                    <div className="relative sm:h-135 lg:h-[556px] mt-5 sm:mt-10 lg:mt-15 px-[18px] sm:px-5 lg:px-8 lg:py-13 pt-5 sm:pt-6 lg:pt-13 pb-30 
                        ...
                        <div className="h-full">
                            ...
                            <p className="text-[12px] sm:text-[16px] lg:text-[20px]">{t('company.aboutSub1')}</p>
                            <p className="text-[12px] sm:text-[16px] lg:text-[20px]">{t('company.aboutSub2')}</p>
                            <p className="text-[12px] sm:text-[16px] lg:text-[20px]">{t('company.aboutSub3')}</p>
                            <p className="text-[12px] sm:text-[16px] lg:text-[20px]">{t('company.aboutSub4')}</p>
                        </div>
                        ...
                        <div className="absolute left-5 bottom-10 sm:left-6 sm:bottom-25 lg:bottom-13 lg:left-28 lg:bottom-20">
                            <div className="flex justify-center gap-2 sm:gap-[11px] lg:gap-6">
                                {[...Array(5)].map((_, index) => (
                                    <div key={index} className="relative size-6 sm:size-12 lg:size-18">
                                        <Image
                    ...
                    <div className="mt-[78px]">
                        <h2 className="text-[20px] lg:text-[30px] font-bold text-center">{t('company.managementPhilosophy.title')}</h2>

                        <div className="border-l-4 border-[#2B5D90] pl-[33px] mt-[14px] mb-[22px]">
                            <h3 className="lg:text-[20px] font-bold">{t('company.managementPhilosophy.label')}</h3>
                        </div>
